...
set :branch, 'master'
set :unicorn_pid, '/home/git/webapps/Muffin-rails_production/current/tmp/pids/unicorn.pid'
...
namespace :setup_unicorn_directory do
  task :sockets do
    on roles(:app) do
      execute :mkdir, '-p /home/git/webapps/Muffin-rails_production/shared/sockets'
    end
  end
end
...
namespace :setup_config_rails do
  task :create_directory do
    on roles(:app) do
      execute :mkdir, '-p /home/git/webapps/Muffin-rails_production/shared/config'
    end
  end

  task :upload_config do
    on roles(:app) do
      upload! '/config/application.yml', '/home/git/webapps/Muffin-rails_production/shared/config'
      upload! '/config/database.yml', '/home/git/webapps/Muffin-rails_production/shared/config'
      upload! '/config/secrets.yml', '/home/git/webapps/Muffin-rails_production/shared/config'
    end
  end
end
# Simple Role Syntax
